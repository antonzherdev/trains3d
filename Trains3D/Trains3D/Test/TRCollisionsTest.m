...
- (TRLevel*)newLevel {
    return [TRLevel levelWithRules:[TRLevelRules levelRulesWithMapSize:GEVec2iMake(5, 3) scoreRules:TRLevelFactory.scoreRules forestRules:TRLevelFactory.forestRules repairerSpeed:30 events:(@[])]];
}
...
- (void)doTest1ForLevel:(TRLevel*)level form:(TRRailForm*)form {
    TRTrain* t1 = [TRTrain trainWithLevel:level trainType:TRTrainType.simple color:TRCityColor.green _cars:^id<CNSeq>(TRTrain* _) {
