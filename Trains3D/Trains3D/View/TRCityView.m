    ...
    [EGGlobal.context.depthTest disabledF:^void() {
        [[_level cities] forEach:^void(TRCity* city) {
            [city.expectedTrainCounter forF:^void(CGFloat time) {
                ...
                [EGD2D drawCircleMaterial:[EGColorSource applyColor:GEVec4Make(1.0, 1.0, 1.0, 1.0)] at:geVec3ApplyVec2Z(geVec2AddVec2([TRCityView moveVecForLevel:_level city:city], geVec2ApplyVec2i(city.tile)), 0.0) radius:0.3 segments:12 start:0.25 end:0.25 - time];
            }];
        }];
    }];
}
