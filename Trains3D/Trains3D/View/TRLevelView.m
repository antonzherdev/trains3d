...
- (id)initWithLevel:(TRLevel*)level {
    ...
    if(self) {
        ...
        _environment = [EGEnvironment environmentWithAmbientColor:GEVec4Make(0.4, 0.4, 0.4, 1.0) lights:(@[[EGDirectLight applyColor:GEVec4Make(1.0, 1.0, 1.0, 1.0) direction:geVec3Normalize(GEVec3Make(-0.15, 0.25, -0.5)) shadowsProjectionMatrix:[GEMat4 orthoLeft:-3.0 right:8.0 bottom:-2.0 top:3.0 zNear:0.0 zFar:10.0]]])];
