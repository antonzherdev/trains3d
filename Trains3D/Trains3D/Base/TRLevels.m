...
+ (void)initialize {
    ...
    if(self == [TRLevels class]) {
        ...
        _TRLevels_level3 = [TRLevelRules levelRulesWithMapSize:GEVec2iMake(5, 3) theme:TRLevelTheme.forest trainComingPeriod:10 scoreRules:[TRLevels scoreRulesWithInitialScore:30000] rewindRules:TRLevelFactory.rewindRules weatherRules:[TRWeatherRules weatherRulesWithSunny:0.0 windStrength:0.3 blastness:0.3 blastMinLength:1.0 blastMaxLength:5.0 blastStrength:0.6 precipitation:[TRLevels lightRain]] repairerSpeed:20 sporadicDamagePeriod:0 events:(@[tuple(@0.0, [TRLevels create2Cities]), tuple(@1.0, [TRLevels showHelpKey:@"help.linesAdvice" text:[TRStr.Loc linesAdvice]]), tuple(@9.0, [TRLevels slowTrain]), tuple(@20.0, [TRLevels slowTrain]), tuple(@10.0, [TRLevels createNewCity]), tuple(@20.0, [TRLevels slowTrain]), tuple(@30.0, [TRLevels slowTrain]), tuple(@30.0, [TRLevels slowTrain]), tuple(@10.0, [TRLevels createNewCity]), tuple(@20.0, [TRLevels slowTrain]), tuple(@30.0, [TRLevels slowTrain]), tuple(@30.0, [TRLevels slowTrain]), tuple(@10.0, [TRLevels createNewCity]), tuple(@10.0, [TRLevels slowTrain]), tuple(@30.0, [TRLevels slowTrain]), tuple(@10.0, [TRLevels slowTrain]), tuple(@30.0, [TRLevels slowTrain]), tuple(@30.0, [TRLevels slowTrain]), tuple(@25.0, [TRLevels slowTrain]), tuple(@30.0, [TRLevels slowTrain]), tuple(@20.0, [TRLevels slowTrain])])];
