...
+ (void)initialize {
    ...
    _TRLevelFactory_rules = (@[[TRLevelRules levelRulesWithMapSize:EGVec2IMake(5, 3) scoreRules:_TRLevelFactory_scoreRules repairerSpeed:30 events:(@[tuple(@1.0, [TRLevelFactory trainCars:intTo(2, 4) speed:[intTo(60, 90) setStep:10]]), tuple(@10.0, [TRLevelFactory trainCars:intTo(2, 4) speed:[intTo(60, 90) setStep:10]]), tuple(@15.0, [TRLevelFactory createNewCity])])]]);
}
