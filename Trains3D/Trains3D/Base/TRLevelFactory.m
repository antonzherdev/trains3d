...
+ (void(^)(TRLevel*))train {
    return [TRLevelFactory trainCars:intTo(1, 6) speed:intTo(20, 50)];
}

+ (void(^)(TRLevel*))expressTrain {
    return [TRLevelFactory expressTrainCars:intTo(3, 6) speed:intTo(75, 100)];
}
