...
+ (void)initialize {
    ...
    _TRLevelFactory_level9 = [TRLevelRules levelRulesWithMapSize:GEVec2iMake(5, 5) theme:TRLevelTheme.leafForest scoreRules:[TRLevelFactory scoreRulesWithInitialScore:60000] weatherRules:[TRWeatherRules weatherRulesWithSunny:1.0 windStrength:0.1 blastness:0.05 blastMinLength:1.0 blastMaxLength:3.0 blastStrength:0.05 precipitation:[CNOption none]] repairerSpeed:20 sporadicDamagePeriod:0 events:(@[tuple(@0.0, [TRLevelFactory create2Cities]), tuple(@5.0, [TRLevelFactory createNewCity]), tuple(@5.0, [TRLevelFactory createNewCity]), tuple(@5.0, [TRLevelFactory createNewCity]), tuple(@5.0, [TRLevelFactory createNewCity]), tuple(@10.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory train]), tuple(@40.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory train]), tuple(@40.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory train]), tuple(@40.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory verySlowTrain]), tuple(@10.0, [TRLevelFactory createNewCity]), tuple(@40.0, [TRLevelFactory verySlowTrain]), tuple(@10.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory train]), tuple(@60.0, [TRLevelFactory train]), tuple(@20.0, [TRLevelFactory train]), tuple(@20.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory verySlowTrain]), tuple(@15.0, [TRLevelFactory train]), tuple(@50.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory train]), tuple(@20.0, [TRLevelFactory verySlowTrain]), tuple(@10.0, [TRLevelFactory train]), tuple(@10.0, [TRLevelFactory train]), tuple(@15.0, [TRLevelFactory train])])];
