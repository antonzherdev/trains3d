...
+ (void)initialize {
    ...
    if(self == [TRDemo class]) {
        ...
        _TRDemo_demoLevel0 = [TRLevelRules levelRulesWithMapSize:PGVec2iMake(5, 5) theme:TRLevelTheme_leafForest trainComingPeriod:5 scoreRules:[TRLevels scoreRulesWithInitialScore:1000000] rewindRules:[TRLevelFactory rewindRules] weatherRules:[TRWeatherRules weatherRulesWithSunny:1.0 windStrength:0.05 blastness:0.01 blastMinLength:1.0 blastMaxLength:3.0 blastStrength:0.3 precipitation:nil] repairerSpeed:20 sporadicDamagePeriod:0 events:(@[tuple(@0.0, [TRDemo createCitiesCount:8]), tuple(@100000.0, [TRLevels verySlowTrain])])];
