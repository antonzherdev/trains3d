...
- (void)testThickLine {
    EGThickLineSegment* l = [EGThickLineSegment thickLineSegmentWithSegment:[EGLineSegment lineSegmentWithP0:EGVec2Make(0.0, 0.0) p1:EGVec2Make(1.0, 0.0)] thickness:1.0];
    ...
    l = [EGThickLineSegment thickLineSegmentWithSegment:[EGLineSegment lineSegmentWithP0:EGVec2Make(0.0, 0.0) p1:EGVec2Make(0.0, 1.0)] thickness:1.0];
    ...
    [self assertEqualsA:[[l segments] toSet] b:[p.segments toSet]];
    CGFloat s2 = sqrt(2.0);
    l = [EGThickLineSegment thickLineSegmentWithSegment:[EGLineSegment lineSegmentWithP0:EGVec2Make(0.0, 0.0) p1:EGVec2Make(1.0, 1.0)] thickness:s2];
