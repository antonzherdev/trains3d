...
+ (GEPerlin1*)applyOctaves:(NSUInteger)octaves frequency:(CGFloat)frequency amplitude:(CGFloat)amplitude {
    return [GEPerlin1 perlin1WithOctaves:octaves frequency:frequency amplitude:amplitude seed:(unsigned int) time(NULL)];
}
...
+ (GEPerlin2*)applyOctaves:(NSUInteger)octaves frequency:(CGFloat)frequency amplitude:(CGFloat)amplitude {
    return [GEPerlin2 perlin2WithOctaves:octaves frequency:frequency amplitude:amplitude seed:(unsigned int) time(NULL)];
}
...
+ (GEPerlin3*)applyOctaves:(NSUInteger)octaves frequency:(CGFloat)frequency amplitude:(CGFloat)amplitude {
    return [GEPerlin3 perlin3WithOctaves:octaves frequency:frequency amplitude:amplitude seed:(unsigned int) time(NULL)];
}
