...
[_director processEvent:[EGViewEvent viewEventWithRecognizerType:__tp__ phase:__phase__ locationInView:__location__ viewSize:_director.view.viewSize param : nil]];\
