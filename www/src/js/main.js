...
//        $('#social').portamento({gap: 0});
        $("#gallery").gallery({
            ...
            items: [
                ...
                '<div class="txt">Send trains to corresponding cities using lightnings and switches</div><img src="/img/scr1.jpg" alt="Send trains to corresponding cities using lightnings and switches"/>',
